...
using MazayTests.Manager.Custom;
...
namespace MazayTests.Manager
{
    ...
    public class CustomScrollbar : UserControl
    {
        ...
        public Image moThumbMiddleImage = null; // поменял для изменения размера
        ...
        protected override void OnPaint(PaintEventArgs e) {
           ...
           // int nSpanHeight = (int)fSpanHeight;
            ...
            // nTop += nSpanHeight;
            //draw middle
           // ThumbMiddleImage.Height = nThumbHeight;
            e.Graphics.DrawImage(ThumbMiddleImage, new Rectangle(1, nTop, this.Width - 2, nThumbHeight  ));//ThumbMiddleImage.Height
